...
<div class="container">
    ...
    <!-- Staff Messages -->
    <div class="mb-5">
        <h5 class="mb-3">Messages from Teacher</h5>
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                <?php
                $staffResult = $connect->query("SELECT * FROM teacher_complaints WHERE recipient = 'subadmin' AND status = 'pending' ORDER BY submitted_at DESC");
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                $staffResult = $connect->query("SELECT * FROM admin_messages WHERE recipient_type = 'staff' AND status = 'pending' ORDER BY sent_at DESC");
