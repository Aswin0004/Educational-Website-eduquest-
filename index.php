  ...
  <div class="slide header11" data-selector="header11">
      <div class="container">
          <div class="banner-text ">
              ...
              <div >
				<a href="login/staff_login.php" class="btn btn-style btn-primary">Staff portal</a>
				<a href="login/index.php" class="btn btn-style btn-primary">Register as student</a>
            </div>
          </div>
      </div>
  </div>
